...
SOURCES = [
    ...
    ("MRPiPS", "govpl",
     "https://www.gov.pl/web/rodzina/aktualnosci", "/web/rodzina/"),
    ("KPRM", "govpl",
     "https://www.gov.pl/web/premier/aktualnosci", "/web/premier/"),
    ("MSZ", "govpl",
     "https://www.gov.pl/web/dyplomacja/aktualnosci", "/web/dyplomacja/"),
]
...
GNEWS_QUERY = {
    ...
    "MRPiPS": "site:gov.pl/web/rodzina cudzoziemcy",
    "KPRM": "site:gov.pl/web/premier migracja",
    "MSZ": "site:gov.pl/web/dyplomacja wizy",
}
...
FILTERED_SOURCES = {"MSWiA", "MRPiPS", "KPRM", "MSZ"}
KEYWORDS = [
    "migra", "deporta", "cudzoziem", "powrot", "powrót", "granic",
    "azyl", "uchodź", "readmisj", "wydal", "legaliz", "wiz",
]

PER_SOURCE = 1          # ile najnowszych wpisów z każdego urzędu
...
def main():
    ...
    # ALARM: gdy żadne źródło nic nie zwróciło, zakończ błędem —
    # GitHub oznaczy uruchomienie na czerwono i wyśle powiadomienie e-mail.
    if sources_ok == 0:
        print("[ALARM] Wszystkie źródła puste — sprawdź, czy układ stron się nie zmienił.")
        sys.exit(1)
